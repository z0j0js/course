...
insert into `chapter` (id, course_id, name) value ('00000000', '00000000', '测试大章00');
...
insert into `section` (id, title, course_id, chapter_id, video, time, charge, sort, created_at, updated_at) VALUE
