...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000224223L);
        request.setTemplateGroupId("f089913697c6c97cc9ecb111df78f76a");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4GA1ejGxPPcpbxE6DCKb";
        //您的AccessKeySecret
        String accessKeySecret = "ozqUwAufxHfasHlgoVgUthZvibCwGg";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\Workspaces\\IDEA\\file\\course\\test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
