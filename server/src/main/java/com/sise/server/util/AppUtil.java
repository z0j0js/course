...
public class AppUtil {
    ...
    public static String notify_url = "http://9rmmnn.natappfree.cc/business/web/pay/getnotify";

    // 页面跳转同步通知页面路径
    //需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    public static String return_url = "http://9rmmnn.natappfree.cc/business/web/pay/getreturn";
